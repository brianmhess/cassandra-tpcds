...
$(customer_address_targets): customer_address.%:
	if [ -f ${OUTDIR}/customer_address_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/customer_address_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.customer_address(ca_address_sk int,ca_address_id text,ca_street_number text,ca_street_name text,ca_street_type text,ca_suite_number text,ca_city text,ca_county text,ca_state text,ca_zip text,ca_country text,ca_gmt_offset double,ca_location_type text)"; fi;
...
$(income_band_targets): income_band.%:
	if [ -f ${OUTDIR}/income_band_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/income_band_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.income_band(ib_income_band_sk int,ib_lower_bound int,ib_upper_bound int)"; fi;
...
$(inventory_targets): inventory.%:
	if [ -f ${OUTDIR}/inventory_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/inventory_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.inventory(inv_date_sk int,inv_item_sk int,inv_warehouse_sk int,inv_quantity_on_hand int)"; fi;
...
$(promotion_targets): promotion.%:
	if [ -f ${OUTDIR}/promotion_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/promotion_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.promotion(p_promo_sk int,p_promo_id text,p_start_date_sk int,p_end_date_sk int,p_item_sk int,p_cost double,p_response_target int,p_promo_name text,p_channel_dmail text,p_channel_email text,p_channel_catalog text,p_channel_tv text,p_channel_radio text,p_channel_press text,p_channel_event text,p_channel_demo text,p_channel_details text,p_purpose text,p_discount_active text)"; fi;
...
$(reason_targets): reason.%:
	if [ -f ${OUTDIR}/reason_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/reason_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.reason(r_reason_sk int,r_reason_id text,r_reason_desc text)"; fi;
...
$(ship_mode_targets): ship_mode.%:
	if [ -f ${OUTDIR}/ship_mode_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/ship_mode_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.ship_mode(sm_ship_mode_sk int,sm_ship_mode_id text,sm_type text,sm_code text,sm_carrier text,sm_contract text)"; fi;
...
$(web_page_targets): web_page.%:
	if [ -f ${OUTDIR}/web_page_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/web_page_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.web_page(wp_web_page_sk int,wp_web_page_id text,wp_rec_start_date text,wp_rec_end_date text,wp_creation_date_sk int,wp_access_date_sk int,wp_autogen_flag text,wp_customer_sk int,wp_url text,wp_type text,wp_char_count int,wp_link_count int,wp_image_count int,wp_max_ad_count int)"; fi;
...
$(web_sales_targets): web_sales.%:
	if [ -f ${OUTDIR}/web_sales_$*_${LISTLEN}.dat ]; then java -cp "build:lib/cassandra-java-driver/*:lib/cassandra-java-driver/lib/*" com.datastax.loader.DelimLoad ${OUTDIR}/web_sales_$*_${LISTLEN}.dat ${IP_ADDR} "tpcds.web_sales(ws_sold_date_sk int,ws_sold_time_sk int,ws_ship_date_sk int,ws_item_sk int,ws_bill_customer_sk int,ws_bill_cdemo_sk int,ws_bill_hdemo_sk int,ws_bill_addr_sk int,ws_ship_customer_sk int,ws_ship_cdemo_sk int,ws_ship_hdemo_sk int,ws_ship_addr_sk int,ws_web_page_sk int,ws_web_site_sk int,ws_ship_mode_sk int,ws_warehouse_sk int,ws_promo_sk int,ws_order_number int,ws_quantity int,ws_wholesale_cost double,ws_list_price double,ws_sales_price double,ws_ext_discount_amt double,ws_ext_sales_price double,ws_ext_wholesale_cost double,ws_ext_list_price double,ws_ext_tax double,ws_coupon_amt double,ws_ext_ship_cost double,ws_net_paid double,ws_net_paid_inc_tax double,ws_net_paid_inc_ship double,ws_net_paid_inc_ship_tax double,ws_net_profit double)"; fi;
